...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['AroonDown','TVMA20','CurrentRatio','RSI','VOL10','minusDI']
...
from Tamplate import AroonDown,TVMA20,CurrentRatio,RSI,VOL10,minusDI

for f in ['AroonDown','TVMA20','CurrentRatio','RSI','VOL10','minusDI']:
