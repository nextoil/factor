...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['AroonDown','TVMA20','CurrentRatio','RSI','VOL10','minusDI','volume','turnover','turnover_ratio','Hurst']
...
from Tamplate import AroonDown,alpha21,TVMA20,CurrentRatio,RSI,VOL10,minusDI,Hurst

for f in ['AroonDown','alpha21','TVMA20','CurrentRatio','RSI','VOL10','minusDI','Hurst']:
